...
@ComponentScan( basePackages ={"org.snaker","com.hhh.fund.usercenter","com.hhh.workflow","com.hhh.fund.flowdemo","com.hhh.fund.ui"}, 
					excludeFilters = @ComponentScan.Filter(value = Controller.class, type = FilterType.ANNOTATION)) 
@EnableJpaRepositories(basePackages = {"com.hhh.fund.usercenter.dao","org.snaker.engine.access.jpa.dao","com.hhh.fund.ui.dao"},
					entityManagerFactoryRef="entityManagerFactory",
					transactionManagerRef="transactionManager")
@EnableTransactionManagement(proxyTargetClass=true)
@Import(value = {CachingConfig.class, SecurityConfig.class, LogUploadConfig.class,MongoContext.class})
...
//	logger.info("Retrieve data source : " + dataSource.getConnection().createStatement());
		...
		lcemf.setPackagesToScan("com.hhh.fund.usercenter.entity","org.snaker.engine.entity","com.hhh.fund.ui.entity");
