...
<%
	...
	HashMap bmData = (HashMap)request.getAttribute("bm_data");
	HashMap tagData = (HashMap)request.getAttribute("tag_data");
	
	PageWord.fillData(doc, bmData);
	PageWord.fillTagData(doc, tagData);
	
	poCtrl.setWriter(doc);
	
	poCtrl.addCustomToolButton("保存","Save",1);
	poCtrl.setSaveFilePage("save_doc1.jsp");
	poCtrl.webOpen(request.getContextPath() + "/doc/word_test.docx", OpenModeType.docNormalEdit, "zhongl");
	...
	<div id="wrapper">
		...
		<!-- top nav -->
    		...
    		<section class="content">
		      <div class="col-lg-12">
					<h3 class="header" id="title_text">>Word数据填充</h3>
				</div>
