...
public interface IQueryService {
	 ...
	 * @return List<Task> 活动任务集合
	 */
	Page<Task> getActiveTasks(QueryFilter filter, Pageable page);
	 ...
	 * @return List<Order> 活动实例集合
	 */
	Page<Order> getActiveOrders(QueryFilter filter, Pageable page);
	 ...
	 * @return List<HistoryOrder> 历史实例集合
	 */
	FundPage<HistoryOrderBean> getHistoryOrders(QueryFilter filter, Pageable page);
	 ...
	 * @return List<HistoryTask> 历史任务集合
	 */
	Page<HistoryTask> getHistoryTasks(QueryFilter filter, Pageable page);
	 ...
	 */
	Page<WorkItem> getWorkItems( QueryFilter filter, Pageable page);
	 ...
	 */
	Page<HistoryOrder> getCCWorks(QueryFilter filter, Pageable page);
	 ...
	 */
	Page<WorkItem> getHistoryWorkItems(QueryFilter filter, Pageable page);
