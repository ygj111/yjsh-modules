...
@Component
public class SpringSnakerEngine 
        implements SnakerEngine, InitializingBean ,ApplicationContextAware{
	@Resource
	private ApplicationContext applicationContext;

	public void afterPropertiesSet() throws Exception {
		new SpringConfiguration(applicationContext);
	}
	...
	private static final Logger log = LoggerFactory.getLogger(SpringSnakerEngine.class);
	/**
	 * Snaker配置对象
	 */
	...
	public List<Task> createFreeTask(String orderId, String operator, Map<String, Object> args, TaskModel model) {
		...
		Process process = process().getProcessById(order.getProcess().getId());//getProcessId());
